...
//     try {
//       dispatch(ShowLoading());
//       const response = await axiosInstance.delete(`/api/bookings/cancel/${selectedBooking._id}`);
//       dispatch(HideLoading());
//       if (response.data.success) {
...
//           onOk={handlePrint}
//           footer={[
//             <button key="print" className="ant-btn ant-btn-primary" onClick={handlePrint}>
//               Print
//             </button>,
//             <button
//               key="cancel"
